          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                Hệ thống xử lý yêu cầu máu khẩn cấp 24/7. Chúng tôi sẽ kết nối với người hiến máu phù hợp trong thời
                gian nhanh nhất.
              </p>
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      {activeEmergencies.map((emergency) => (
                        <div
                          key={emergency.id}
                          className={`p-3 rounded-lg border ${getUrgencyColor(emergency.urgency)}`}
                        >
