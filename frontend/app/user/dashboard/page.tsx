                          ...
                          <div className="space-y-3">
                            ...
                            <div>
                              ...
                              {donor?.health_cert_url ? (
                                ...
                                <p className="text-gray-500 text-sm">Chưa có bằng sức khỏe</p>
                              )}
                            </div>
                            <div>
                      ...
                      {(user?.role === "recipient") && (
                        <div>
                          ...
                          <div className="space-y-3">
                            ...
                            <div>
                              <label className="text-sm text-gray-600">Giấy tờ y tế</label>
                              {recipient?.medical_doc_url ? (
                                ...
                                <p className="text-gray-500 text-sm">Chưa có giấy tờ y tế</p>
                              )}
                            </div>
                            <div>
                              <label className="text-sm text-gray-600">Ngày được tạo</label>
