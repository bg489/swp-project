...
export function GuestAccessWarning({
  ...
  const getPageFeatures = (pageName: string) => {
    switch (pageName) {
      case "donate":
        return [
      ...
      case "blood-request":
        return [
          "Gửi yêu cầu máu cho staff bệnh viện",
          "Kiểm tra tương thích nhóm máu và thành phần",
          "Theo dõi trạng thái yêu cầu máu",
          "Nhận thông báo khi có người hiến phù hợp",
        ]
      case "emergency":
        return [
